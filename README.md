...
The 2.x branch is not compatible with Magento 2.4.7+.  
For compatibility with Magento 2.4.0+ please switch to the 3.x branch.  
This branch will only receive security fixes from version 2.9.1.
